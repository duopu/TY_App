		...
		<view class="form-wrapper">
			...
			<view class="" v-else>
				...
				<view class="flex-center-between input-with-icon">
					...
					<image class="icon" v-if="eye == 1" @click="toggleEye" src="../../assets/imgs/login/eye-close.png" mode="aspectFill"></image>
					<image class="icon" v-if="eye == 2" @click="toggleEye" src="../../assets/imgs/login/eye.png" mode="aspectFill"></image>
				</view>
			...
			<view class="through flex-center-center"><text>其他登录方式</text></view>

			<view class="methods flex-center-center">
				<image class="methods-image" src="../../assets/imgs/login/qq.png" mode="aspectFill"></image>
				<image class="methods-image" src="../../assets/imgs/login/wx.png" mode="aspectFill"></image>
				<image class="methods-image" src="../../assets/imgs/login/zfb.png" mode="aspectFill"></image>
			</view>
			<image class="advert-image" src="../../assets/imgs/login/advert.png" mode="aspectFill"></image>
		</view>
	</view>
</template>
