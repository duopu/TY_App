	...
	<view class="money">
		...
		<view class="block-box">
			...
			<view class="flex-center-center">
				...
				<button class="btn btn-light" v-if="info.cashDepositState == 1" @click="applyRefund">保证金退款</button>
				<button class="btn btn-light" v-if="info.cashDepositState == 2">退款中</button>
			</view>
		</view>
		<!-- 保证金说明 -->
		<view class="block-box">
		...
		<common-payment-popup-easy ref="payment" @setOrderPaytypeSelect="setOrderPaytypeSelect">
		</common-payment-popup-easy>
	</view>
</template>
...
<script>
	export default {
		...
		methods: {
			...
			// 退保证金
			applyRefund() {
				this.$http.post('/cash/deposit/applyRefund',{},true).then(res=>{
					this.$tool.showSuccess('申请成功')
				})
			}
		}
	};
