<template>
	<scroll-view scroll-y="true" class="check-in-form">
		...
		<check-in-form-item label="*店铺名称">
			<input v-model="shopInfo.storeName" type="text" class="input" placeholder-class="input-placeholder"
				placeholder="请输入店铺名称" />
		</check-in-form-item>
		<check-in-form-item label="*主营类目" align="start">
			<textarea v-model="shopInfo.mainDesc" type="text" class="input textarea h-180"
				placeholder-class="input-placeholder" placeholder="请输入主营类目" />
		</check-in-form-item>
		<check-in-form-item label="*机构简介" align="start">
			<textarea v-model="shopInfo.storeDesc" type="text" class="input textarea h-300"
				placeholder-class="input-placeholder" placeholder="请输入机构简介" />
		</check-in-form-item>
	</scroll-view>
</template>
